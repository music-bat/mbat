...
# Dear Maintainer, use this script to interact with the mailserver.
# Documentation can be found here: https://docker-mailserver.github.io/docker-mailserver/edge/config/setup.sh/
